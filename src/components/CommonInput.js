...
const CommonInput = ({ type, placeholder, label, icon: Icon, iconColor, togglePasswordVisibility }) => {
    return (
        <div className="mb-5 relative">
            <label className="mb-2.5 block text-[#1E1F20] text-xs font-medium leading-5 tracking-[1px] uppercase">{label}</label>
